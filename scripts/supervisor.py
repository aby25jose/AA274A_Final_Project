...
class Supervisor:
    ...
    def __init__(self):
        ...
        ## Dictionary and parameters that stores the positions of the animals and stops signs detected in the world 
        ...
        # Command pulish object detected (this is only for debugging purposes to count how many times it adds the pose of the same obj to the dictionary)
    ...
    def stop_sign_detected_callback(self, msg):
        ...
        if dist > 0 and dist < self.params.stop_min_dist and self.mode == Mode.NAV:
            ...
            #             self.obj_pose_dict[self.count_obj] = [self.curr_robot_pos.x, self.curr_robot_pos.y, self.curr_robot_pos.theta]
